...
namespace らんちゃ {
    public partial class DummyForm : Form {
        ...
        public DummyForm() {
            ...
            // 設定ファイルの読み込み
            config = らんちゃ.Config.Deserialize();
        ...
        private void notifyIcon1_DoubleClick(object sender, EventArgs e) {
            switch (config.IconDoubleClick) {
                ...
                case 1: 設定CToolStripMenuItem_Click(this, null); break;
                default: break;
            }
        }
        ...
        private void ネットワーク更新設定OToolStripMenuItem_Click(object sender, EventArgs e) {
            using (Toolkit.Updater.UpdateConfigForm form = new Toolkit.Updater.UpdateConfigForm(config.UpdateConfig)) {
        ...
        private void ネットワーク更新NToolStripMenuItem_Click(object sender, EventArgs e) {
            ...
            using (Toolkit.Updater.UpdateForm form = new Toolkit.Updater.UpdateForm(url,
