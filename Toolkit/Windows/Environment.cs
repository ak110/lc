...
namespace Toolkit.Windows {
	...
	public static class Environment {
		...
		/// </summary>
		/// <remarks>
		/// System.Environmentのには↓しか無いので。。
		///     Desktop, Programs, Personal, MyDocuments,
		///     Favorites, Startup, Recent, SendTo,
		///     StartMenu, MyMusic, DesktopDirectory, MyComputer,
		...
		public static string GetFolderPath(SpecialFolder folder) {
			...
			if (idl == IntPtr.Zero) {
				throw new System.IO.IOException("特殊フォルダパスの取得に失敗");
			}
		...
		#region SHGetSpecialFolderLocationとか色々
