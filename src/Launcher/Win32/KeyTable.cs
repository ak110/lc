...
public static class KeyTable
{
    ...
    public enum Keys
    {
        ...
        RLClick, LRClick,   //右→左クリック, 左→右クリック
                            // キーの数
        KeyCount,
    }
    ...
    static KeyTable()
    {
        ...
        _n(Keys.X1Click, "4ボタンクリック"); _n(Keys.X1Double, "4ボタンダブルクリック");
        _n(Keys.X2Click, "5ボタンクリック"); _n(Keys.X2Double, "5ボタンダブルクリック");
        _n(Keys.RLClick, "右→左クリック"); _n(Keys.LRClick, "左→右クリック");
    }
    ...
    public static string GetKeyName(Keys key)
    {
        ...
        {
            System.Diagnostics.Debug.Fail("空のキーコード：" + key);
            return null;
        }
    }
