...
namespace Launcher.UI {
	partial class RegisterStartup {
		...
		private void InitializeComponent() {
			...
			this.button1.Text = "共有のｽﾀｰﾄｱｯﾌﾟに登録";
			...
			this.button6.Location = new System.Drawing.Point(160, 72);
			...
			this.Name = "RegisterStartup";
			this.Size = new System.Drawing.Size(220, 102);
			this.Load += new System.EventHandler(this.RegisterStartup_Load);
